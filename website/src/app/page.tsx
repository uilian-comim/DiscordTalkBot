...
export default function Login() {
    return (
        <div className="w-full h-full flex justify-center px-8 py-8 bg-base-100 md:px-11 md:py-12 lg:px-20 lg:py-20">
                ...
                <div className="w-full flex flex-col items-center justify-center gap-4">
                    <div className="form-control w-full">
                        <label htmlFor="token" className="label">
                            <span className="label-text uppercase font-primary font-medium text-base">Bot Token</span>
                        </label>
                        <input
                            type="text"
                            id="token"
